...
import { 
  ...
  // Added CheckCircle to fix errors on lines 574 and 603
  CheckCircle
} from 'lucide-react';
...
export const AbsensiPage: React.FC = () => {
  ...
  // Added printFilename to fix error on line 711
              ...
              {!cameraActive ? (
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                     {/* IN PANEL */}
                     <div className={`p-6 rounded-[2rem] border-2 transition-all relative overflow-hidden ${modalData.detail?.jamMasuk ? 'border-emerald-100 bg-emerald-50/30' : 'border-dashed border-gray-200 bg-gray-50'}`}>
           ...
           <div className="mt-12 flex justify-end">
              <div className="text-center min-w-[280px] text-black">
                 ...
                 <div className="w-full">
                    {/* Nama dan Gelar Digabung, Bold, Underline, whitespace-nowrap */}
